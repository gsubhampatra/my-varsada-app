...
const CouponInput: React.FC<CouponInputProps> = React.memo(
  ({ applyCoupon }) => {
        ...
        >
          <View style={styles.checkboxContainer}>
            <View
              style={[
                styles.checkbox,
                isCoinRedeemed && styles.checkboxSelected,
              ]}
            >
...
const PaymentOptions: React.FC<PaymentOptionProps> = React.memo(
  ({ onAddCardPress }) => {
...
const CheckoutScreen: React.FC = () => {
  ...
  const { setCheckoutCalculate, checkoutCalculate } =
    useCheckoutCalculateStore();
