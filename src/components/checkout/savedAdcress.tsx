...
import AddAddressDrawer from "./addressDrawer";
...
const CustomCheckbox = React.memo<CustomCheckboxProps>(({ checked, onPress }) => (
  <TouchableOpacity
...
export default function SavedAddressScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* Header */}
      <Navbar
        navText="Saved Address"
        navColor={GColors.primary}
        openDrawer={handleGoBack}
      />
      {/* Address List */}
      <View style={styles.addressListContainer}>
        ...
        />
        <TouchableOpacity style={styles.newAddressButton} onPress={handleOpenDrawer}>
